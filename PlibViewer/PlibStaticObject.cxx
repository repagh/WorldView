...
void PlibCenteredObject::iterate(TimeTickType ts, const BaseObjectMotion &base,
                                 double late)
{
...
void PlibTiledObject::iterate(TimeTickType ts, const BaseObjectMotion &base,
                              double late)
{
  double cpos[3] = {
...
static SubContractor<PlibObjectTypeKey, PlibTiledObject>
  *PlibTiledObject_maker =
    new SubContractor<PlibObjectTypeKey, PlibTiledObject>("tiled");
